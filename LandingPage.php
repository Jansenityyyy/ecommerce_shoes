...
<head>
    ...
    <style>
        ...
        @keyframes glow {
            ...
            50% {
                box-shadow: 0 4px 25px rgba(255, 61, 0, 0.7);
            }
        }
            ...
            <div class="limited-card">
                ...
                <div class="limited-info">
                    ...
                    <div class="btn-group">
                        ...
                        <button class="btn-cart" id="limited-add-cart"><i class="fas fa-cart-plus"></i> Add to
                            Cart</button>
            ...
            <div class="row">
                ...
                <div class="footer-col-4">
                    ...
                    <ul>
                        ...
                        <li><a href="https://www.instagram.com/JansenMark04"><i class="fa-brands fa-instagram"></i>
                                Instagram</a></li>
                        <li><a href="https://www.youtube.com/JansenMark04"><i class="fa-brands fa-youtube"></i>
                                YouTube</a></li>
                        <li><a href="https://www.tiktok.com/@JansenMark04"><i class="fa-brands fa-tiktok"></i>
                                TikTok</a></li>
                    </ul>
                </div>
            </div>
